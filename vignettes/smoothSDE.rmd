...
file <- paste0("Elliptical Time-Density Model (Wall et al. 2014) ",
               "African Elephant Dataset (Source-Save the Elephants).csv")
track <- read.csv(file)[,c(11, 13, 14, 17, 4, 5, 6)] |>
    setNames(c("ID", "x", "y", "date", "lon", "lat", "temp")) |>
    subset(ID == unique(ID)[1])
