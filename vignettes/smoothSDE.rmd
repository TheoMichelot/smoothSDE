...
The package is centred around the R6 class _SDE_, which encapsulates a varying-coefficient stochastic differential equation model, as described in by @michelot2020.

The constructor SDE\$new can be used to create a model object, and its main arguments are:
