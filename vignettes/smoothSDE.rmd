...
# To-do list
    ...
    - Remove hard-coded values from e-seal SSM specification in SDE\$setup. Add argument to pass extra parameters/data needed for given model?
