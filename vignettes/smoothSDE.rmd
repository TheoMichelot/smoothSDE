...
Brownian motion and the Ornstein-Uhlenbeck process have a wide range of applications (e.g., ecology, finance), and the continuous-time correlated random walk is a popular model of animal movement described by @johnson2008.
...
``` {r example-plot, fig.width = 5, fig.height = 4, fig.show="hold", out.width="50%"}
...
Estimates and point-wise confidence intervals of the SDE parameters can also be computed for given covariate values, using the predict_par method.
